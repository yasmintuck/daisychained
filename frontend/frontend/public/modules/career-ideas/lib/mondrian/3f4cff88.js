...
`),an=[{icon:en,value:"improve",text:"Improve writing"},{icon:Oo,value:"proofread",text:"Fix spelling and grammar"},{icon:Ho,value:"shorten",text:"Make shorter"},{icon:jo,value:"lengthen",text:"Make longer"},{icon:Xo,value:"changeTone",text:"Change tone",submenu:[{value:"changeTone_professional",text:"Professional"},{value:"changeTone_casual",text:"Casual"},{value:"changeTone_straightforward",text:"Straightforward"},{value:"changeTone_confident",text:"Confident"},{value:"changeTone_friendly",text:"Friendly"},{value:"changeTone_custom",text:"Custom"}]},{icon:Qo,value:"changeAudience",text:"Change audience"},{icon:No,value:"simplify",text:"Simplify Writing"}],rn=[{icon:zo,value:"boldKeyTerms",text:"Bold key terms"},{icon:Uo,value:"addEmojis",text:"Add emojis"}],on=[{icon:Yo,value:"continue",text:"Continue writing"},{icon:Ko,value:"explain",text:"Explain this"},{icon:Ko,value:"suggestImprovements",text:"Suggest improvements"},{icon:Ko,value:"findSynonyms",text:"Find synonyms"},{icon:Ko,value:"createAnalogy",text:"Create an analogy"},{icon:Ko,value:"createScenario",text:"Create a scenario"},{icon:Ko,value:"createKeyTakeaways",text:"Create key takeaways"},{icon:Ko,value:"createImagePrompt",text:"Create an AI image prompt"}],nn=[{icon:Ko,value:"createHaiku",text:"Write a haiku"}],sn=[{icon:Ko,value:"writeAboutTopic",text:"Write about..."},{icon:Ko,value:"write1ParagraphAboutTopic",text:"Write 1 paragraph"},{icon:Ko,value:"write2ParagraphsAboutTopic",text:"Write 2 paragraphs"},{icon:Ko,value:"write3ParagraphsAboutTopic",text:"Write 3 paragraphs"}],ln=[{icon:Jo,value:"replace",text:"Replace selection"},{icon:Do,value:"append",text:"Insert below"},{icon:$o,value:"copy",text:"Copy"},{icon:Yo,value:"continue",text:"Continue writing"},{icon:Wo,value:"discard",text:"Cancel"}],cn=[{icon:Eo,value:"retry",text:"Try again"},{icon:Wo,value:"discard",text:"Cancel"}],dn={improve:{option:"improve"},proofread:{option:"proofread"},lengthen:{option:"lengthen"},shorten:{option:"shorten"},changeTone_professional:{option:"changeTone",params:{tone:"professional"}},changeTone_casual:{option:"changeTone",params:{tone:"casual"}},changeTone_straightforward:{option:"changeTone",params:{tone:"straightforward"}},changeTone_confident:{option:"changeTone",params:{tone:"confident"}},changeTone_friendly:{option:"changeTone",params:{tone:"friendly"}},changeTone_custom:{option:"changeTone"},changeAudience:{option:"changeAudience"},simplify:{option:"simplify"},copy:{option:"copy"},append:{option:"append"},replace:{option:"replace"},continue:{option:"continue"},discard:{option:"discard"},retry:{option:"retry"},boldKeyTerms:{option:"boldKeyTerms"},addEmojis:{option:"addEmojis"},explain:{option:"explain"},suggestImprovements:{option:"suggestImprovements"},findSynonyms:{option:"findSynonyms"},createAnalogy:{option:"createAnalogy"},createScenario:{option:"createScenario"},createKeyTakeaways:{option:"createKeyTakeaways"},createImagePrompt:{option:"createImagePrompt"},createHaiku:{option:"createHaiku"},writeAboutTopic:{option:"writeAboutTopic"},write1ParagraphAboutTopic:{option:"write1ParagraphAboutTopic"},write2ParagraphsAboutTopic:{option:"write2ParagraphsAboutTopic"},write3ParagraphsAboutTopic:{option:"write3ParagraphsAboutTopic"}};let hn=class extends Vo{constructor(){super(...arguments),this.menu="initial",this.submenuAnchor=this,this.handleMenuSubmit=e=>{const{detail:t}=e,a=dn[t.value];a&&this.dispatchEvent(new CustomEvent("canned-option:submit",{detail:a}))},this.handleSubmenuTriggerClick=(e,t)=>{e.currentTarget instanceof HTMLElement&&(this.selected!==t?(this.selected=t,this.submenuAnchor=e.currentTarget):this.closeSubmenu())},this.openSubmenu=e=>{this.selected!==e.detail.value&&(this.selected=e.detail.value,this.submenuAnchor=e.detail.target)},this.closeSubmenu=()=>{this.selected=void 0,this.submenuAnchor=this},this.onMenuEscape=()=>{this.selected&&(this.selected=void 0,this.submenuAnchor=this)}}render(){return Lo.qy`
    ...
    `}renderInitialMenuOptions(){return"initial"!==this.menu?Lo.s6:Lo.qy`
    ...
    `}renderReplyMenuOptions(){return"reply"!==this.menu?Lo.s6:Lo.qy`
      ${this.renderMenuItemGroup(ln)}
      ${this.renderEditSelectionsOptions()}
      ${this.renderFormatSelectionOptions()}
    `}renderScratchMenuOptions(){return"scratch"!==this.menu?Lo.s6:this.renderScratchOptions()}renderCanceledMenuOptions(){return"canceled"!==this.menu?Lo.s6:Lo.qy`${this.renderMenuItemGroup(cn)}`}renderEditSelectionsOptions(){return Lo.qy`
      <strong class="menu-heading">Edit selection</strong>
      ${this.renderMenuItemGroup(an)}
    `}renderFormatSelectionOptions(){return Lo.qy`
      <strong class="menu-heading">Format selection</strong>
      ${this.renderMenuItemGroup(rn)}
    `}renderGenerateFromSelectionOptions(){return Lo.qy`
      <strong class="menu-heading">Generate from selection</strong>
      ${this.renderMenuItemGroup(on)}
    `}renderPromptOptions(){return Lo.qy`
      <strong class="menu-heading">Prompt</strong>
      ${this.renderMenuItemGroup(nn)}
    `}renderScratchOptions(){return Lo.qy`
      <strong class="menu-heading">Generate from scratch</strong>
      ${this.renderMenuItemGroup(sn)}
    `}renderMenuItemGroup(e){return Lo.qy`
      ${e.map((e=>e.submenu?.length?Lo.qy`
            <mon-menu-item
              value=${e.value}
              data-has-icons
        ...
        `))}
    `}renderSubmenu({submenu:e,value:t}){return t===this.selected&&e?Lo.qy`
        <mon-popover
      ...
      `:Lo.qy``}};hn.styles=tn,(0,To.Cg)([(0,Po.MZ)({type:String})],hn.prototype,"menu",void 0),(0,To.Cg)([(0,Po.wk)()],hn.prototype,"submenuAnchor",void 0),(0,To.Cg)([(0,Po.wk)()],hn.prototype,"selected",void 0),hn=(0,To.Cg)([(0,Po.EM)("mon-ai-writer-canned-options")],hn);var pn=a(5494),un=a(6394),mn=a(1959),gn=a(2602),vn=a.n(gn),fn=a(5792);class bn{constructor({onCancel:e,onDone:t,onResult:a,onSubmitted:i,fetch:r}){if(this.sessionId=window.crypto.randomUUID(),this.process=async(e,t)=>{const{onDone:a,onResult:i,onSubmitted:r}=this;r();const o=await this.fetch(this.sessionId,e,{signal:t.signal});if(!t.signal.aborted){const a=o.pipeThrough(new Sn).getReader(),r=()=>{this.onCancel(),a.cancel()};t.signal.addEventListener("abort",r);try{await a.read().then((function t({done:r,value:o}){if(!r)return i({input:e,output:o}),a.read().then(t)}))}finally{t.signal.removeEventListener("abort",r)}}a()},!r)throw new Error("AI Writer must be initialized with a defined AIResponseFetcher function");this.onCancel=e,this.onDone=t,this.onResult=a,this.onSubmitted=i,this.fetch=r}}class Sn extends TransformStream{static _guardHtml(e){const t=e.lastIndexOf("<");return-1===t||-1!==e.slice(t+1).indexOf(">")}constructor(e){let t=e?.response??"";super({start(a){null!=e&&a.enqueue(t)},transform(e,a){t+=e,Sn._guardHtml(t)&&a.enqueue(t)}})}}const Cn=e=>{class t extends e{constructor(){super(...arguments),this.initialContent="",this.aiResponseFetcher=void 0,this.courseId="mondrian-test",this.status="prompt",this.userInput="",this.aiResponses=[],this.selectedResponseIndex=0,this.domParser=new DOMParser,this.updateLastResponse=vn()((e=>{const t=[...this.aiResponses],a=t.pop();a&&(this.aiResponses=[...t,{...a,...e}])}),64),this.addNewResponse=()=>{this.aiResponses=[...this.aiResponses,{prompt:this.userInput,response:"",menu:"reply"}],this.selectedResponseIndex=this.aiResponses.length-1},this.incrementResponseIndex=()=>{this.selectedResponseIndex<=this.aiResponses.length-1&&this.selectedResponseIndex++},this.decrementResponseIndex=()=>{this.selectedResponseIndex>0&&this.selectedResponseIndex--},this.handleInput=e=>{this.userInput=e.target.value},this.submitInput=()=>{this.userInput.length&&this.requestResult({content:this.contentForSubmit||"<p> </p>",key:"custom",prompt:this.userInput})},this.requestResult=e=>{this.abortController=new AbortController,this.aiStreamInstance.process({...e,wentBack:this.wentBack},this.abortController).catch((e=>{("AbortError"!==e.name||e instanceof fn.AbortError)&&(this.status="error")}))},this.fillPrompt=e=>{const t=In[e];t&&(this.userInput=`${t} `)},this.handleCannedOption=({option:e,params:t})=>{switch(e){case"changeTone":t&&t.tone?this.requestResult({content:this.contentForSubmit,key:e,tone:t.tone}):this.fillPrompt(e);break;case"changeAudience":case"createBulletedList":case"createNumberedList":case"createTable":case"writeAboutTopic":case"write1ParagraphAboutTopic":case"write2ParagraphsAboutTopic":case"write3ParagraphsAboutTopic":this.fillPrompt(e);break;case"continue":this.requestResult({content:this.contentForSubmit,key:e});break;case"append":this.dispatchEvent(new CustomEvent("append",{detail:this.contentForSubmit}));break;case"replace":this.dispatchEvent(new CustomEvent("replace",{detail:this.contentForSubmit}));break;case"copy":navigator.clipboard.writeText(this.contentForSubmit).then((()=>{console.log("copied to clipboard")}));break;case"discard":this.dispatchEvent(new CustomEvent("blur"));break;case"retry":{const{retry:e}=this.currentResponse;e&&this.requestResult(e[0]);break}default:this.requestResult({content:this.contentForSubmit,key:e,...t??{}})}},this.stopGeneratingAIResponse=()=>{this.abortController&&this.abortController.abort();const e=this.aiResponses[this.aiResponses.length-1];e.response?.length||(this.aiResponses.pop(),this.decrementResponseIndex()),this.status="prompt"}}get currentMenu(){return this.currentResponse.menu??"initial"}get currentResponse(){return 0===this.aiResponses.length?yn(this.initialContent):this.aiResponses[this.selectedResponseIndex]}get responseCount(){return this.aiResponses.length}get displayedResult(){const{currentResponse:e}=this;return function(e){const t=document.createElement("div");return t.innerHTML=e,t.querySelectorAll("[style]").forEach((e=>{e.removeAttribute("style")})),t.innerHTML}(e.response||this.initialContent)}get contentForSubmit(){const e=this.currentResponse.response||this.initialContent,t=this.domParser.parseFromString(e,"text/html");return 1===t.body.children.length&&t.body.firstChild instanceof Element&&"P"===t.body.firstChild.nodeName&&""===t.body.firstChild.innerHTML?(t.body.firstChild.innerHTML=" ",t.body.outerHTML):e}get wentBack(){return Math.max(this.aiResponses.length-this.selectedResponseIndex-1,0)}get aiStreamInstance(){return this.aiStream||(this.aiStream=new bn({onCancel:()=>{this.currentResponse.menu="canceled"},onDone:()=>{this.status="prompt",this.userInput=""},onResult:({input:e,output:t})=>{try{"streaming"!==this.status&&(this.status="streaming"),this.updateLastResponse({response:t,retry:[e]})}catch{this.status="error"}},onSubmitted:()=>{this.status="pending",this.addNewResponse()},fetch:this.aiResponseFetcher})),this.aiStream}connectedCallback(){super.connectedCallback(),this.aiResponses.length||this.aiResponses.push(yn(this.initialContent))}}return(0,To.Cg)([(0,Po.MZ)({type:String})],t.prototype,"initialContent",void 0),(0,To.Cg)([(0,Po.MZ)()],t.prototype,"aiResponseFetcher",void 0),(0,To.Cg)([(0,Po.MZ)({type:String})],t.prototype,"courseId",void 0),(0,To.Cg)([(0,Po.wk)()],t.prototype,"status",void 0),(0,To.Cg)([(0,Po.wk)()],t.prototype,"userInput",void 0),(0,To.Cg)([(0,Po.wk)()],t.prototype,"aiResponses",void 0),(0,To.Cg)([(0,Po.wk)()],t.prototype,"selectedResponseIndex",void 0),t},In={changeAudience:"Rewrite this for an intended audience of",changeTone:"Change the tone to",createBulletedList:"Write a bulleted list about",createNumberedList:"Write a numbered list about",createTable:"Create a table about",writeAboutTopic:"Write about",write1ParagraphAboutTopic:"Write 1 paragraph about",write2ParagraphsAboutTopic:"Write 2 paragraphs about",write3ParagraphsAboutTopic:"Write 3 paragraphs about"};function yn(e){const t=document.createElement("div");return t.innerHTML=e,{prompt:"",response:e,menu:t.innerText.trim().length>0?"initial":"scratch"}}const wn=Lo.AH`
  :host * {
    box-sizing: border-box;
...
`;let xn=class extends(Cn(Vo)){constructor(){super(...arguments),this.offset=12,this.positionConfig={middleware:[(0,pn.cY)(this.offset)]},this.stopMouseEventPropagation=!1,this.inputRef=(0,un._)(),this.resultsMutationObserver=new MutationObserver((()=>{const e=this.$(".response");e&&e.scrollTo(0,e.scrollHeight)})),this.handleInputSubmit=e=>{e.preventDefault(),this.submitInput()},this.handleCannedOptionSelect=e=>{this.handleCannedOption(e.detail)},this.maybeStopPropagation=e=>{this.stopMouseEventPropagation&&this.stopPropagation(e)},this.stopPropagation=e=>{e.stopPropagation()},this.handleBlur=e=>{this.dispatchEvent(new CustomEvent("blur"))},this.handlePaginationClick=e=>{const t=e.currentTarget;"decrement"===t.name&&this.decrementResponseIndex(),"increment"===t.name&&this.incrementResponseIndex(),this.status="prompt"}}get isGenerating(){return["pending","streaming"].includes(this.status)}willUpdate(e){const t=e.get("status"),a=this.status,i=this.$(".response");i&&("streaming"!==t&&"streaming"===a&&this.resultsMutationObserver.observe(i,{subtree:!0,childList:!0}),"streaming"===t&&"prompt"===a&&this.resultsMutationObserver.disconnect())}renderSubmitButton(){if(!this.isGenerating){const e=this.userInput.length<=0;return Lo.qy`
      ...
      `}}renderResponseContents(){return"error"===this.status?Lo.qy`<span class="errorMessage">An error occurred</span>`:["prompt","streaming"].includes(this.status)?Lo.qy`<span>${(0,mn._)(this.displayedResult)}</span>`:Lo.qy`<span>Loading...</span>`}renderResponse(){return"scratch"===this.currentMenu?Lo.s6:Lo.qy`<div class="response">${this.renderResponseContents()}</div>`}renderPopoverContent(){return Lo.qy`
      <div class="content">
        <div class="body">
          ${this.renderResponse()}
          <div class="input-section">
            <div class="decorative-icons">${Zo}</div>
            <form @submit=${this.handleInputSubmit}>
              <input
                ${(0,un.K)(this.inputRef)}
    ...
    `}firstUpdated(e){super.firstUpdated(e),window.requestAnimationFrame((()=>{this.inputRef.value&&this.inputRef.value.focus({preventScroll:!0})}))}renderCannedOptionMenu(){if(!this.isGenerating)return Lo.qy`
        <mon-ai-writer-canned-options
          @canned-option:submit=${this.handleCannedOptionSelect}
          .menu=${this.currentMenu}
        ></mon-ai-writer-canned-options>
      `}renderMiscActions(){return this.isGenerating?Lo.qy`
        <div class="stop">
          <button @click=${this.stopGeneratingAIResponse}>
            Stop generating
          </button>
        </div>
      `:this.renderPagination()}renderPagination(){const{responseCount:e,selectedResponseIndex:t}=this,a=t+1;if(this.responseCount>1)return Lo.qy`
        <div class="pagination">
          <button
            ...
            name="decrement"
          >
            <span class="left-chevron">${_o}</span>
          </button>
          ...
          <button
            ...
            name="increment"
          >
            <span class="right-chevron">${_o}</span>
          </button>
        </div>
      `}render(){return Lo.qy`
      <mon-draggable
    ...
    `}};xn.styles=wn,(0,To.Cg)([(0,Po.MZ)({type:Number})],xn.prototype,"offset",void 0),(0,To.Cg)([(0,Po.MZ)({type:Object})],xn.prototype,"positionConfig",void 0),(0,To.Cg)([(0,Po.MZ)({type:Boolean})],xn.prototype,"stopMouseEventPropagation",void 0),(0,To.Cg)([(0,Po.wk)()],xn.prototype,"inputRef",void 0),xn=(0,To.Cg)([(0,Po.EM)("mon-ai-writer")],xn);var kn=a(6678),Mn=a(1514);const Tn=Lo.AH`
...
`;let Ln=class extends Vo{constructor(){super(...arguments),this.closeOnBackgroundClick=!1,this.disableClose=!1,this.animationDuration=250,this.open=!1,this.titleText="",this.noBackdrop=!1,this.dialogStyles={},this.closing=!1}async updated(e){if(super.updated(e),e.has("open")){const t=e.get("open");t||!0!==this.open?t&&!1===this.open&&this.closeModal():this.dialog?.showModal()}}handleBGClick(e){this.closeOnBackgroundClick&&e.target===this.dialog&&this.closeModal()}handleKeyDown(e){"Escape"===e.key&&(e.preventDefault(),e.stopPropagation(),this.closeModal())}closeModal(){this.dialog.open&&!this.closing&&(this.closing=!0,setTimeout((()=>{this.dialog.close(),this.dispatchEvent(new CustomEvent("artDialogClosed",{bubbles:!0,composed:!0})),this.closing=!1}),this.animationDuration))}connectedCallback(){super.connectedCallback(),this.style.setProperty("--animation-duration",`${this.animationDuration}ms`)}render(){const e={"no-backdrop":this.noBackdrop,open:this.open,closing:this.closing};return Lo.qy`
      ...
      >
        <div class="dialog-wrap">
          ...
          <div class="dialog-header">
            <slot name="title">
              ${this.titleText?Lo.qy`<h1>${this.titleText}</h1>`:Lo.s6}
            </slot>
            ${this.disableClose?Lo.s6:Lo.qy`
                  <button
                    class="close-button"
    ...
    `}};Ln.styles=Tn,(0,To.Cg)([(0,Po.P)("dialog")],Ln.prototype,"dialog",void 0),(0,To.Cg)([(0,Po.MZ)({type:Boolean})],Ln.prototype,"closeOnBackgroundClick",void 0),(0,To.Cg)([(0,Po.MZ)({type:Boolean})],Ln.prototype,"disableClose",void 0),(0,To.Cg)([(0,Po.MZ)({type:Number})],Ln.prototype,"animationDuration",void 0),(0,To.Cg)([(0,Po.MZ)({type:Boolean})],Ln.prototype,"open",void 0),(0,To.Cg)([(0,Po.MZ)({type:String})],Ln.prototype,"titleText",void 0),(0,To.Cg)([(0,Po.MZ)({type:Boolean})],Ln.prototype,"noBackdrop",void 0),(0,To.Cg)([(0,Po.MZ)({attribute:!1})],Ln.prototype,"dialogStyles",void 0),(0,To.Cg)([(0,Po.wk)()],Ln.prototype,"closing",void 0),Ln=(0,To.Cg)([(0,Po.EM)("art-modal")],Ln);const An=Lo.AH`
  * {
    box-sizing: border-box;
    font-size: 10px;
  }
...
`;let Rn=class extends Vo{constructor(){super(...arguments),this.slot="tab",this.label="",this.role="tab",this.value="",this["aria-selected"]="false",this.selected=!1,this.disabled=!1,this.tabIndex=-1,this.bindEvents=()=>{this.on("click",this.onClick)}}onClick(){this.dispatch("art-tab:change")}render(){return Lo.qy`
      <span class="content">
        <slot name="icon"></slot>
    ...
    `}};Rn.styles=An,(0,To.Cg)([(0,Po.MZ)({type:String,reflect:!0})],Rn.prototype,"slot",void 0),(0,To.Cg)([(0,Po.MZ)({type:String})],Rn.prototype,"label",void 0),(0,To.Cg)([(0,Po.MZ)({type:String,reflect:!0})],Rn.prototype,"role",void 0),(0,To.Cg)([(0,Po.MZ)({type:String})],Rn.prototype,"value",void 0),(0,To.Cg)([(0,Po.MZ)({type:String,reflect:!0})],Rn.prototype,"aria-selected",void 0),(0,To.Cg)([(0,Po.MZ)({type:Boolean,reflect:!0})],Rn.prototype,"selected",void 0),(0,To.Cg)([(0,Po.MZ)({type:Boolean,reflect:!0})],Rn.prototype,"disabled",void 0),(0,To.Cg)([(0,Po.MZ)({type:String,reflect:!0})],Rn.prototype,"aria-controls",void 0),(0,To.Cg)([(0,Po.MZ)({type:Number,reflect:!0})],Rn.prototype,"tabIndex",void 0),Rn=(0,To.Cg)([(0,Po.EM)("art-tab")],Rn);const Bn=Lo.AH`
  * {
    box-sizing: border-box;
  }
`;let Fn=class extends Vo{constructor(){super(...arguments),this.value="",this.slot="panel"}render(){return Lo.qy`
      <div
        role="tabpanel"
        id=${this.id}
      >
    ...
    `}};Fn.styles=Bn,(0,To.Cg)([(0,Po.MZ)({type:String})],Fn.prototype,"value",void 0),(0,To.Cg)([(0,Po.MZ)({type:String,reflect:!0})],Fn.prototype,"slot",void 0),(0,To.Cg)([(0,Po.MZ)({type:String,reflect:!0})],Fn.prototype,"aria-labelledby",void 0),Fn=(0,To.Cg)([(0,Po.EM)("art-tab-panel")],Fn);const Pn=Lo.AH`
  * {
    box-sizing: border-box;
  }
...
`;let $n=class extends Vo{constructor(){super(...arguments),this.selected=!1,this.tabIndex=-1,this.role="menuitem",this.delegatesFocus=!1,this.focusableRef=(0,un._)(),this.bindEvents=()=>{this.on("mouseenter",(()=>{this.dispatch("hover",{value:this.value,hovered:!0})})),this.on("click",this.onClick),this.on("focus",(()=>{if(this.delegatesFocus){const e=this.querySelector('a, button, input, textarea, select, details, [tabindex]:not([tabindex="-1"])');e instanceof HTMLElement&&e.focus()}}))}}onClick(){this.dispatch("mon-menu-item:select")}render(){return Lo.qy`
      <slot name="icon"></slot>
      <div class="content">
        <slot></slot>
        <div class="extras">
    ...
    `}};$n.formAssociated=!0,$n.styles=Jn,$n.shadowRootOptions={...Lo.WF.shadowRootOptions,delegatesFocus:!1},(0,To.Cg)([(0,Po.MZ)({type:String,reflect:!0})],$n.prototype,"value",void 0),(0,To.Cg)([(0,Po.MZ)({type:Boolean,reflect:!0})],$n.prototype,"selected",void 0),(0,To.Cg)([(0,Po.MZ)({type:Number,reflect:!0})],$n.prototype,"tabIndex",void 0),(0,To.Cg)([(0,Po.MZ)({type:String,reflect:!0})],$n.prototype,"role",void 0),(0,To.Cg)([(0,Po.MZ)()],$n.prototype,"delegatesFocus",void 0),(0,To.Cg)([(0,Po.wk)()],$n.prototype,"focusableRef",void 0),$n=(0,To.Cg)([(0,Po.EM)("mon-menu-item")],$n);const Zn=Lo.AH`
  * {
    box-sizing: border-box;
  }
...
`,jn={enabled:!1,padding:0,boundary:"clippingAncestors",prioritizeResize:!1,minResizeHeight:0,minResizeWidth:0,enableShiftCrossAxis:!1,flipPadding:0,shiftPadding:0,maxResizeHeight:1/0,maxResizeWidth:1/0,avoidFlipOverlap:!1,matchAnchorWidth:!1};let En=class extends Vo{constructor(){super(...arguments),this.autoFlip=!0,this.autoResizeOptions={},this.customMiddleware=[],this.autoShift=!0,this.semantic=!1,this.enableAutoUpdates=!0,this.semanticPriority=0,this.offset=10,this.placement="bottom",this.positionInitialized=!1,this.sizeMiddlewareOptions={...jn,...this.autoResizeOptions},this.middleware=[],this.syncMiddleware=()=>{this.sizeMiddlewareOptions={...jn,...this.autoResizeOptions};const e=this.sizeMiddlewareOptions.avoidFlipOverlap,t=this.sizeMiddlewareOptions.minResizeWidth,a=this.sizeMiddlewareOptions.maxResizeWidth,i=this.sizeMiddlewareOptions.minResizeHeight,r=this.sizeMiddlewareOptions.maxResizeHeight,o=this.sizeMiddlewareOptions.matchAnchorWidth,n="number"==typeof this.sizeMiddlewareOptions.shiftPadding?this.sizeMiddlewareOptions.shiftPadding:this.sizeMiddlewareOptions.shiftPadding.top??0,s=this.sizeMiddlewareOptions.enabled&&(0,pn.Ej)({apply({availableWidth:s,availableHeight:l,elements:c,rects:d,y:h,placement:p}){const u=r?`${r}px`:"",m=[l,r,window.innerHeight-n];if(e){const e=c.reference.getBoundingClientRect().top;e>h&&p.includes("top")&&m.push(window.innerHeight-(window.innerHeight-e)-n)}const g=`${Math.max(i,Math.min(...m))}px`;c.floating.style.maxHeight=l>=c.floating.scrollHeight?u:g,c.floating.style.maxWidth=`${Math.max(t,Math.min(a,s))}px`,o&&(c.floating.style.minWidth=`${d.reference.width}px`)},padding:this.sizeMiddlewareOptions.padding,boundary:this.sizeMiddlewareOptions.boundary}),l=this.autoShift&&(0,pn.BN)({crossAxis:this.sizeMiddlewareOptions.enableShiftCrossAxis,padding:this.sizeMiddlewareOptions.shiftPadding}),c=(0,pn.cY)(this.offset);this.sizeMiddlewareOptions.prioritizeResize?this.middleware=[s,this.autoFlip&&(0,pn.UU)({fallbackStrategy:"initialPlacement",flipAlignment:!1,padding:this.sizeMiddlewareOptions.flipPadding}),l,...this.customMiddleware,c].filter((e=>!!e)):this.middleware=[this.autoFlip&&(0,pn.UU)({padding:this.sizeMiddlewareOptions.flipPadding}),l,s,...this.customMiddleware,c].filter((e=>!!e))},this.updatePosition=()=>{this.anchor&&(0,pn.rD)(this.anchor,this,{placement:this.placement,strategy:"fixed",middleware:this.middleware}).then((({x:e,y:t})=>{this.style.left=`${e}px`,this.style.top=`${t}px`,this.reconcilePositionChanges()}))},this.reconcilePositionChanges=Hn()((()=>{window.requestAnimationFrame((()=>{this.positionInitialized||(this.dispatchEvent(new CustomEvent("initialized")),this.positionInitialized=!0)}))}),50,{leading:!1,trailing:!0})}updated(e){if(super.updated(e),Array.from(e.keys()).some((e=>["autoFlip","autoShift","autoResizeOptions","customMiddleware","offset"].includes(e)))&&this.syncMiddleware(),e.has("semantic")&&(this.semantic?(this.hasAttribute("popover")||(this.setAttribute("popover","manual"),function(e,t){const a=[];let i;{let r=0;for(;r<er.length;r+=1){const e=er[r];if(e.order>t)break;a.push(e)}for(i=r,a.push({element:e,order:t});r<er.length;r+=1){const e=er[r];e.element.hidePopover(),a.push(e)}}for(let e=i;e<a.length;e+=1)a[e].element.showPopover();er=a}(this,this.semanticPriority)),this.collectOff((()=>{this.hasAttribute("popover")&&(tr(this),this.removeAttribute("popover"))}))):this.hasAttribute("popover")&&(tr(this),this.removeAttribute("popover"))),e.has("anchor")&&this.anchor)if(this.enableAutoUpdates){this.autoUpdateDisposer&&this.autoUpdateDisposer();const e=(0,pn.ll)(this.anchor,this,this.updatePosition,{animationFrame:!0});this.collectOff(e),this.autoUpdateDisposer=e}else this.updatePosition()}render(){return Lo.qy`<slot></slot>`}};En.styles=Yn,(0,To.Cg)([(0,Po.MZ)()],En.prototype,"anchor",void 0),(0,To.Cg)([(0,Po.MZ)({type:Boolean})],En.prototype,"autoFlip",void 0),(0,To.Cg)([(0,Po.MZ)({type:Object})],En.prototype,"autoResizeOptions",void 0),(0,To.Cg)([(0,Po.MZ)({type:Array})],En.prototype,"customMiddleware",void 0),(0,To.Cg)([(0,Po.MZ)({type:Boolean})],En.prototype,"autoShift",void 0),(0,To.Cg)([(0,Po.MZ)({type:Boolean,reflect:!0})],En.prototype,"semantic",void 0),(0,To.Cg)([(0,Po.MZ)({type:Boolean})],En.prototype,"enableAutoUpdates",void 0),(0,To.Cg)([(0,Po.MZ)({type:Number,reflect:!0})],En.prototype,"semanticPriority",void 0),(0,To.Cg)([(0,Po.MZ)()],En.prototype,"offset",void 0),(0,To.Cg)([(0,Po.MZ)({type:String})],En.prototype,"placement",void 0),(0,To.Cg)([(0,Po.wk)()],En.prototype,"positionInitialized",void 0),En=(0,To.Cg)([(0,Po.EM)("mon-popover")],En);const Nn=Lo.AH`
  * {
    box-sizing: border-box;
  }
...
`;let qn=class extends Vo{constructor(){super(...arguments),this.value=null,this.popoverPlacement="bottom-end",this.placeholder="Choose an item...",this.open=!1,this.labelText="",this.anchorRef=(0,un._)(),this.scrollBarWidth=ar,this.cancel=()=>{this.open&&(this.dispatch("mon-select:cancel"),this.dispatch("mon-select:close")),this.open=!1},this.onMenuEscape=()=>{this.cancel()},this.onSubmit=e=>{this.open=!1,e.stopPropagation(),this.dispatch("mon-select:close"),this.dispatch("mon-select:change",{name:this.name,value:e.detail.value})},this.onClickOutside=()=>{this.cancel()},this.onClickTrigger=()=>{this.open?this.cancel():(this.open=!0,this.dispatch("mon-select:open"))},this.onKeyDown=e=>{"ArrowLeft"===e.key&&e.stopPropagation()},this.onButtonKeyDown=e=>{"Enter"===e.key?e.preventDefault():"ArrowDown"===e.key&&(e.stopPropagation(),this.open=!0,this.dispatch("mon-select:open"))},this.onSlotChange=()=>{this.syncLabelText()},this.syncLabelText=()=>{this.labelText=this.$$$("mon-menu-item")?.filter((e=>e.value===this.value))[0]?.innerText??this.placeholder},this.handleRefChange=e=>{this.anchorRef=e}}get $selected(){return this.$$$("mon-menu-item[selected]")[0]}bindEvents(){this.on("mon-menu:escape",this.onMenuEscape),this.on("keydown",this.onKeyDown),this.collectOff(Ro("mousedown",window,(e=>{const t=e.composedPath();e.target instanceof Node&&!t.includes(this)&&this.onClickOutside()}),{capture:!0,passive:!0}))}updated(e){e.has("value")&&this.syncLabelText(),this.open&&!1===e.get("open")&&window.requestAnimationFrame((()=>{const e=this.$$$("mon-menu-item")?.find((e=>e.value===this.value));e?.scrollIntoView({behavior:"instant",block:"nearest"})}))}renderTrigger(){return Lo.qy`
    ...
    `}renderMenu(){return this.open?Lo.qy`
          <mon-popover
        ...
        ></slot>`}render(){return Lo.qy`${this.renderTrigger()}${this.renderMenu()}`}};qn.styles=Nn,(0,To.Cg)([(0,Po.MZ)({type:String,reflect:!0})],qn.prototype,"name",void 0),(0,To.Cg)([(0,Po.MZ)({type:String})],qn.prototype,"value",void 0),(0,To.Cg)([(0,Po.MZ)({type:String})],qn.prototype,"popoverPlacement",void 0),(0,To.Cg)([(0,Po.MZ)()],qn.prototype,"placeholder",void 0),(0,To.Cg)([(0,Po.wk)()],qn.prototype,"open",void 0),(0,To.Cg)([(0,Po.wk)()],qn.prototype,"labelText",void 0),(0,To.Cg)([(0,Po.wk)()],qn.prototype,"anchorRef",void 0),(0,To.Cg)([(0,Po.wk)()],qn.prototype,"scrollBarWidth",void 0),qn=(0,To.Cg)([(0,Po.EM)("mon-select")],qn);const Gn=Lo.AH`
  *,
  *:before,
  *:after {
    box-sizing: border-box;
...
`;let Xn=class extends Vo{constructor(){super(...arguments),this.focusedByClick=!1,this.animationDuration=250}toggleSwitch(e){!0===e?this.toggle?.classList.add("active"):!1===e?this.toggle?.classList.remove("active"):this.toggle?.classList.toggle("active")}handleClick(){this.focusedByClick=!0,this.checkboxes[0].checked=!this.checkboxes[0].checked,this.checkboxes[0].dispatchEvent(new Event("change")),setTimeout((()=>{this.focusedByClick=!1}))}handleFocus(){setTimeout((()=>{!1===this.focusedByClick&&this.toggleVisibleFocus(!0)}))}handleBlur(){this.toggleVisibleFocus(!1)}toggleVisibleFocus(e){!0===e?this.toggle.classList.add("in-focus"):this.toggle.classList.remove("in-focus")}handleCheckboxChange(e){const t=e.target;this.toggleSwitch(t.checked)}handleKeydown(e){"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),this.handleClick())}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.checkboxes.forEach((e=>{this.toggleSwitch(e.checked),e.style.left="0",e.style.opacity="0.01",e.style.outline="none !important",e.style.position="absolute",e.style.top="0",e.addEventListener("focus",this.handleFocus.bind(this)),e.addEventListener("blur",this.handleBlur.bind(this)),e.addEventListener("change",this.handleCheckboxChange.bind(this)),e.addEventListener("keydown",this.handleKeydown.bind(this))}))}render(){return Lo.qy`
    ...
    `}};Xn.styles=Gn,(0,To.Cg)([(0,Po.P)(".toggle")],Xn.prototype,"toggle",void 0),(0,To.Cg)([(0,Po.P)(".control")],Xn.prototype,"control",void 0),(0,To.Cg)([(0,Po.KN)({selector:'input[type="checkbox"]'})],Xn.prototype,"checkboxes",void 0),(0,To.Cg)([(0,Po.wk)()],Xn.prototype,"focusedByClick",void 0),(0,To.Cg)([(0,Po.MZ)({type:Number})],Xn.prototype,"animationDuration",void 0),Xn=(0,To.Cg)([(0,Po.EM)("mon-toggle")],Xn);const Un=(e,t)=>{const a=t.cssText,i=new WeakSet;return t=>{const r=t.getRootNode();if(!i.has(r)){i.add(r);const t=(r instanceof ShadowRoot?r.ownerDocument:r instanceof Document?r:document).createElement("style");t.setAttribute("data-svelte-lit-styles",e),t.textContent=a,r.appendChild(t)}}},Kn=Lo.AH`
  &[data-flex='1'] {
...
`),i.Dn('<svg viewBox="0 0 100 100" data-element="button-spinner"><circle data-element="spinner-circle" cx="50%" cy="50%" r="45%" stroke-width="12.5%" pathLength="1"></circle><circle data-element="spinner-progress" cx="50%" cy="50%" r="45%" stroke-width="12.5%" pathLength="1"></circle></svg>'),i.vs('<span data-element="button-content"><!></span> <!>',1),i.vs('<a arc-button=""><!></a>'),i.vs('<button arc-button=""><!></button>');const rs=Lo.AH`
